...
const UserProfile = () => {
    ...
    return ((0, jsx_runtime_1.jsxs)(Layout_1.default, { title: "User Profile", children: [error && (0, jsx_runtime_1.jsx)("div", { className: "error-message", children: error }), (0, jsx_runtime_1.jsxs)("div", { className: "tabs", children: [(0, jsx_runtime_1.jsx)("button", { className: `tab ${activeTab === 'profile' ? 'active' : ''}`, onClick: () => setActiveTab('profile'), children: "Profile" }), (0, jsx_runtime_1.jsx)("button", { className: `tab ${activeTab === 'loans' ? 'active' : ''}`, onClick: () => setActiveTab('loans'), children: "My Loans" }), (0, jsx_runtime_1.jsx)("button", { className: `tab ${activeTab === 'favorite' ? 'active' : ''}`, onClick: () => setActiveTab('favorite'), children: "Favorite Book" })] }), (0, jsx_runtime_1.jsxs)("div", { className: "tab-content", children: [activeTab === 'profile' && ((0, jsx_runtime_1.jsxs)("section", { className: "profile-section", children: [(0, jsx_runtime_1.jsx)("h2", { children: "Profile Information" }), (0, jsx_runtime_1.jsxs)("p", { children: [(0, jsx_runtime_1.jsx)("strong", { children: "Email:" }), " ", user?.username || 'Unknown'] }), (0, jsx_runtime_1.jsxs)("p", { children: [(0, jsx_runtime_1.jsx)("strong", { children: "Role:" }), " ", user?.role || 'User'] }), (0, jsx_runtime_1.jsxs)("div", { className: "profile-image-container", children: [(0, jsx_runtime_1.jsx)("h3", { children: "Profile Image" }), (0, jsx_runtime_1.jsx)("div", { className: "profile-image-display", children: profile?.profile_image ? ((0, jsx_runtime_1.jsx)("img", { src: buildImageSrc(profile.profile_image), alt: "Profile", className: "profile-image", style: {
                                                maxWidth: '200px',
                                                maxHeight: '200px',
                                                objectFit: 'cover',
