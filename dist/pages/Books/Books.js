...
require("./BooksCards.css");
const Books = () => {
    const { isAdmin, user } = (0, AuthContext_1.useAuth)();
    ...
    const [bookLoans, setBookLoans] = (0, react_1.useState)({});
        ...
        try {
            const loanPromises = books.map(async (book) => {
                const [loanStatus, userLoan] = await Promise.all([
                    api_1.default.get(`/api/books/${book.book_id}/loan-status`),
                    user ? api_1.default.get(`/api/books/${book.book_id}/my-loan`) : Promise.resolve({ data: { hasLoan: false } })
                ]);
                return {
                    bookId: book.book_id,
    ...
    const handleRentBook = async (bookId) => {
        try {
            await api_1.default.post(`/api/rent/${bookId}`);
    ...
    const handleReturnBook = async (bookId) => {
        ...
        try {
            await api_1.default.post(`/api/books/${bookId}/return`);
    ...
    return ((0, jsx_runtime_1.jsxs)(Layout_1.default, { title: "Livros", children: [error && (0, jsx_runtime_1.jsx)("div", { className: "error-message", children: error }), (0, jsx_runtime_1.jsxs)("section", { className: "featured-carousel", style: { marginBottom: 24 }, children: [(0, jsx_runtime_1.jsx)("h2", { style: { marginBottom: 12 }, children: "Novidades" }), slidesLength === 0 ? (books.length > 0 ? ((0, jsx_runtime_1.jsx)("div", { style: { padding: 16, background: '#fff', borderRadius: 10, border: '2px solid #1976d2' }, children: (0, jsx_runtime_1.jsx)("div", { style: { display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(260px, 1fr))', gap: 16 }, children: books.slice(0, 8).map((bk) => ((0, jsx_runtime_1.jsxs)("div", { style: { display: 'flex', gap: 14, alignItems: 'center', border: '1px solid #e0e0e0', borderRadius: 10, padding: 12, background: '#fff' }, children: [(0, jsx_runtime_1.jsx)("div", { style: { width: 70, height: 100, background: '#f5f5f5', display: 'flex', alignItems: 'center', justifyContent: 'center', borderRadius: 8, overflow: 'hidden', flex: '0 0 auto', alignSelf: 'center' }, children: bk.photo ? ((0, jsx_runtime_1.jsx)("img", { src: bk.photo.startsWith('http') || bk.photo.startsWith('/') ? bk.photo : `/api/uploads/${bk.photo}`, alt: bk.title, style: { width: '100%', height: '100%', objectFit: 'cover' } })) : ((0, jsx_runtime_1.jsx)("span", { style: { color: '#999', fontSize: 11 }, children: "Sem imagem" })) }), (0, jsx_runtime_1.jsxs)("div", { style: { minWidth: 0, flex: 1 }, children: [(0, jsx_runtime_1.jsx)("div", { style: { fontWeight: 700, fontSize: 16, whiteSpace: 'nowrap', textOverflow: 'ellipsis', overflow: 'hidden' }, children: bk.title }), (0, jsx_runtime_1.jsxs)("div", { style: { color: '#666', fontSize: 12, marginTop: 4 }, children: ["Autor: ", getAuthorName(bk.author_id) || 'Desconhecido'] }), (0, jsx_runtime_1.jsx)("div", { style: { color: '#777', marginTop: 6, fontSize: 12, lineHeight: 1.45, overflow: 'hidden', textOverflow: 'ellipsis', display: '-webkit-box', WebkitLineClamp: 2, WebkitBoxOrient: 'vertical', minHeight: 36 }, children: bk.description || '—' })] })] }, `fallback-${bk.book_id}`))) }) })) : ((0, jsx_runtime_1.jsx)("div", { style: { padding: 20, background: '#fff', borderRadius: 8, border: '2px solid #1976d2' }, children: (0, jsx_runtime_1.jsx)("div", { style: { textAlign: 'center', color: '#666' }, children: "Sem livros para exibir no carrossel." }) }))) : ((0, jsx_runtime_1.jsxs)("div", { style: { position: 'relative', overflow: 'hidden', borderRadius: 10, border: '2px solid #1976d2', background: '#fff', height: 240 }, children: [(() => {
                                ...
                                return ((0, jsx_runtime_1.jsx)("div", { style: { position: 'absolute', top: '50%', left: 0, right: 0, transform: 'translateY(calc(-50% + 8px))', padding: '0 72px', background: '#fff' }, children: (0, jsx_runtime_1.jsxs)("div", { onClick: () => navigate(`/books/${bk.book_id}`), style: { display: 'grid', gridTemplateColumns: 'auto 1fr', alignItems: 'center', columnGap: 18, width: '100%', maxWidth: 920, cursor: 'pointer', margin: '0 auto' }, children: [(0, jsx_runtime_1.jsx)("div", { style: { width: 96, height: 136, background: '#f5f5f5', display: 'flex', alignItems: 'center', justifyContent: 'center', borderRadius: 10, overflow: 'hidden', boxShadow: '0 2px 8px rgba(0,0,0,0.08)' }, children: bk.photo ? ((0, jsx_runtime_1.jsx)("img", { src: bk.photo.startsWith('http') || bk.photo.startsWith('/') ? bk.photo : `/api/uploads/${bk.photo}`, alt: bk.title, style: { width: '100%', height: '100%', objectFit: 'cover' } })) : ((0, jsx_runtime_1.jsx)("span", { style: { color: '#999', fontSize: 12 }, children: "Sem imagem" })) }), (0, jsx_runtime_1.jsxs)("div", { style: { minWidth: 0, flex: 1, maxWidth: 620, display: 'flex', flexDirection: 'column', justifyContent: 'center', gap: 6 }, children: [(0, jsx_runtime_1.jsx)("div", { style: { fontWeight: 800, fontSize: 20, lineHeight: 1.2, overflow: 'hidden', display: '-webkit-box', WebkitLineClamp: 2, WebkitBoxOrient: 'vertical', minHeight: 48 }, children: bk.title }), (0, jsx_runtime_1.jsxs)("div", { style: { color: '#5a5a5a', fontSize: 13, lineHeight: 1.2 }, children: ["Autor: ", getAuthorName(bk.author_id) || 'Desconhecido'] }), (0, jsx_runtime_1.jsx)("div", { style: { color: '#777', fontSize: 13, lineHeight: 1.45, overflow: 'hidden', textOverflow: 'ellipsis', display: '-webkit-box', WebkitLineClamp: 3, WebkitBoxOrient: 'vertical', minHeight: 56 }, children: bk.description || '—' })] })] }) }, bk.book_id));
                                        ...
                                        } })) : ((0, jsx_runtime_1.jsx)("div", { className: "no-image", children: "Sem imagem" })) }), (0, jsx_runtime_1.jsx)("div", { className: "book-card-content", children: editingBook === book.book_id ? ((0, jsx_runtime_1.jsxs)("div", { className: "edit-form", children: [(0, jsx_runtime_1.jsx)("input", { type: "text", value: editData.title, onChange: (e) => setEditData({ ...editData, title: e.target.value }), placeholder: "T\u00EDtulo do livro" }), (0, jsx_runtime_1.jsx)("select", { value: editData.author_id, onChange: (e) => setEditData({ ...editData, author_id: e.target.value }), children: authors.map(author => ((0, jsx_runtime_1.jsx)("option", { value: author.author_id, children: author.name_author }, author.author_id))) }), (0, jsx_runtime_1.jsxs)("div", { className: "edit-actions", children: [(0, jsx_runtime_1.jsx)("button", { className: "save-btn", onClick: handleSaveEdit, children: "Salvar" }), (0, jsx_runtime_1.jsx)("button", { className: "cancel-btn", onClick: handleCancelEdit, children: "Cancelar" })] })] })) : ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)("h3", { className: "book-card-title", title: book.title, children: book.title }), (0, jsx_runtime_1.jsxs)("p", { className: "book-card-author", children: ["por ", getAuthorName(book.author_id) || 'Autor desconhecido'] }), (0, jsx_runtime_1.jsx)("p", { className: "book-card-description", children: book.description || 'Sem descrição disponível para este livro.' }), (0, jsx_runtime_1.jsxs)("div", { className: "book-card-meta", children: [(0, jsx_runtime_1.jsxs)("span", { children: ["ID: ", book.book_id] }), book.deleted_at && (0, jsx_runtime_1.jsx)("span", { style: { color: '#ff9800', fontWeight: 'bold' }, children: "EXCLU\u00CDDO" }), !book.deleted_at && bookLoans[book.book_id]?.isRented && ((0, jsx_runtime_1.jsxs)("span", { style: { color: '#f44336', fontWeight: 'bold' }, children: ["ALUGADO POR: ", bookLoans[book.book_id]?.loan?.username] })), !book.deleted_at && userLoans[book.book_id]?.hasLoan && ((0, jsx_runtime_1.jsx)("span", { style: { color: '#4caf50', fontWeight: 'bold' }, children: "VOC\u00CA ALUGOU ESTE LIVRO" }))] }), (0, jsx_runtime_1.jsxs)("div", { className: "book-card-actions", children: [(0, jsx_runtime_1.jsx)("button", { type: "button", onClick: () => navigate(`/books/${book.book_id}`), "aria-label": "Ver detalhes", title: "Ver detalhes", className: "icon-button", children: (0, jsx_runtime_1.jsx)("svg", { width: "16", height: "16", viewBox: "0 0 24 24", fill: "none", xmlns: "http://www.w3.org/2000/svg", children: (0, jsx_runtime_1.jsx)("path", { d: "M12 5C7 5 2.73 8.11 1 12c1.73 3.89 6 7 11 7s9.27-3.11 11-7c-1.73-3.89-6-7-11-7Zm0 12a5 5 0 1 1 0-10 5 5 0 0 1 0 10Zm0-2a3 3 0 1 0 0-6 3 3 0 0 0 0 6Z", fill: "currentColor" }) }) }), !book.deleted_at && ((0, jsx_runtime_1.jsx)(jsx_runtime_1.Fragment, { children: userLoans[book.book_id]?.hasLoan ? ((0, jsx_runtime_1.jsx)("button", { type: "button", onClick: () => handleReturnBook(book.book_id), "aria-label": "Devolver livro", title: "Devolver livro", className: "icon-button", style: { borderColor: '#ff9800', color: '#ff9800' }, children: (0, jsx_runtime_1.jsx)("svg", { width: "16", height: "16", viewBox: "0 0 24 24", fill: "none", xmlns: "http://www.w3.org/2000/svg", children: (0, jsx_runtime_1.jsx)("path", { d: "M12 5v2a5 5 0 1 1-4.9 6h2.02A3 3 0 1 0 12 9v2l4-3-4-3Z", fill: "currentColor" }) }) })) : bookLoans[book.book_id]?.isRented ? ((0, jsx_runtime_1.jsx)("button", { type: "button", disabled: true, "aria-label": "Livro j\u00E1 alugado", title: `Livro alugado por ${bookLoans[book.book_id]?.loan?.username || 'outro usuário'}`, className: "icon-button", style: { borderColor: '#ccc', color: '#ccc', cursor: 'not-allowed' }, children: (0, jsx_runtime_1.jsx)("svg", { width: "16", height: "16", viewBox: "0 0 24 24", fill: "none", xmlns: "http://www.w3.org/2000/svg", children: (0, jsx_runtime_1.jsx)("path", { d: "M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm5 11H7v-2h10v2z", fill: "currentColor" }) }) })) : ((0, jsx_runtime_1.jsx)("button", { type: "button", onClick: () => handleRentBook(book.book_id), "aria-label": "Alugar livro", title: "Alugar livro", className: "icon-button", style: { borderColor: '#4caf50', color: '#4caf50' }, children: (0, jsx_runtime_1.jsx)("svg", { width: "16", height: "16", viewBox: "0 0 24 24", fill: "none", xmlns: "http://www.w3.org/2000/svg", children: (0, jsx_runtime_1.jsx)("path", { d: "M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm5 8h-3V7h-4v3H7l5 5 5-5z", fill: "currentColor" }) }) })) })), isAdmin && ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)("button", { type: "button", onClick: () => handleEditBook(book), "aria-label": "Editar", title: "Editar", className: "icon-button", children: (0, jsx_runtime_1.jsx)("svg", { width: "16", height: "16", viewBox: "0 0 24 24", fill: "none", xmlns: "http://www.w3.org/2000/svg", children: (0, jsx_runtime_1.jsx)("path", { d: "M3 17.25V21h3.75L17.81 9.94l-3.75-3.75L3 17.25Zm18-11.5a1 1 0 0 0 0-1.41l-2.34-2.34a1 1 0 0 0-1.41 0l-1.83 1.83 3.75 3.75L21 5.75Z", fill: "currentColor" }) }) }), book.deleted_at ? ((0, jsx_runtime_1.jsx)("button", { type: "button", onClick: () => handleRestoreBook(book.book_id), "aria-label": "Restaurar", title: "Restaurar", className: "icon-button", style: { borderColor: '#4caf50', color: '#4caf50' }, children: (0, jsx_runtime_1.jsx)("svg", { width: "16", height: "16", viewBox: "0 0 24 24", fill: "none", xmlns: "http://www.w3.org/2000/svg", children: (0, jsx_runtime_1.jsx)("path", { d: "M12 5v2a5 5 0 1 1-4.9 6h2.02A3 3 0 1 0 12 9v2l4-3-4-3Z", fill: "currentColor" }) }) })) : ((0, jsx_runtime_1.jsx)("button", { type: "button", onClick: () => handleDeleteBook(book.book_id), "aria-label": "Excluir", title: "Excluir", className: "icon-button", style: { borderColor: '#f44336', color: '#f44336' }, children: (0, jsx_runtime_1.jsx)("svg", { width: "16", height: "16", viewBox: "0 0 24 24", fill: "none", xmlns: "http://www.w3.org/2000/svg", children: (0, jsx_runtime_1.jsx)("path", { d: "M6 7h12v14a2 2 0 0 1-2 2H8a2 2 0 0 1-2-2V7Zm11-3h-3.5l-1-1h-3L8 4H5v2h14V4Z", fill: "currentColor" }) }) }))] }))] })] })) })] }, book.book_id))) }), totalPages > 1 && ((0, jsx_runtime_1.jsx)("div", { className: "pagination", children: Array.from({ length: totalPages }, (_, i) => ((0, jsx_runtime_1.jsx)("button", { onClick: () => handlePageChange(i), className: currentPage === i ? 'active' : '', children: i + 1 }, i))) }))] }))] }));
};
