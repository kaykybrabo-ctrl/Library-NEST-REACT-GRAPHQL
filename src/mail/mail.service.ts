...
export class MailService {
  ...
  async sendPasswordResetEmail(to: string, context: { username?: string; resetUrl: string }) {
    const templatePath = join(process.cwd(), 'src', 'mail', 'templates', 'reset-password.pug')
    try {
